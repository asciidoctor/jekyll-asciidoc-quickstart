...
The Jekyll AsciiDoc Quickstart project is a leg-up in starting your own website hosted on Github with content based in AsciiDoc.  This project combines the power of AsciiDoc with a beautiful CSS framework ontop of Github's existing publishing infrastructure.
...
=== 5. Encrypt the GitHub Token for Travis CI
