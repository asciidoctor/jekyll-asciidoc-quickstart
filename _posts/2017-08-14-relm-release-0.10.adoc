...
However, when developing titanium, I've again got bitten by the infamous borrow mut error at runtime, while this was precisely https://antoyo.github.io/jekyll-relm-blog/relm-intro#state_mutation[one issue] relm tries to solve.
